...
// **FIX: Memoized CertificationsSection**
    ...
    <div className="border-b border-gray-200 dark:border-dark-border">
      ...
      {expanded && (
        <div className="px-6 pb-6 space-y-4">
          ...
          <Button variant="outline" fullWidth onClick={() => addCertification()}>
            + Add Certification
          </Button>
        </div>
      )}
...
// **MAIN FIX: Pure component with NO state that causes re-renders on input changes**
export function ResumeForm() {
  return (
    <div className="space-y-0 bg-white dark:bg-dark-card rounded-xl shadow-sm border border-gray-100 dark:border-dark-border overflow-hidden">
      <PersonalInfoSection />
      <SummarySection />
